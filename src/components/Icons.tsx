// Bespoke nautical icons for the personal brand
// Hand-crafted SVG icons with refined stroke work

interface IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number
}

// Compass rose - for navigation/direction
export function CompassIcon({ size = 20, className, ...props }: IconProps) {
  return (
    ...
    >
      ...
      <polygon points="12,5 13.5,11 12,10 10.5,11" fill="currentColor" stroke="none" />
      <polygon points="12,19 10.5,13 12,14 13.5,13" strokeWidth="1" />
...
// Anchor - for stability/foundation
export function AnchorIcon({ size = 20, className, ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      width={size}
    ...
    >
      ...
      <line x1="7" y1="21" x2="12" y2="17" />
      <line x1="17" y1="21" x2="12" y2="17" />
    </svg>
  )
}

// Quill - for writing/articles
export function QuillIcon({ size = 20, className, ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      width={size}
      ...
      {...props}
    >
      <path d="M20 4c-2 0-4 2-6 6l-5 5-3 5 5-3 5-5c4-2 6-4 6-6 0-1-1-2-2-2z" />
      <path d="M9 15l-2 2" />
      <path d="M15 9c1-2 1-4 0-5" />
    </svg>
  )
}

// Ship wheel - for projects/building
...
// Scroll/Map - for CV/experience
export function ScrollIcon({ size = 20, className, ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      width={size}
      ...
      {...props}
    >
      <path d="M6 3c-1.5 0-3 1-3 3v12c0 2 1.5 3 3 3" />
      <path d="M6 3h12c1.5 0 3 1 3 3v12c0 2-1.5 3-3 3H6" />
      <path d="M6 21c1.5 0 3-1 3-3V6c0-2-1.5-3-3-3" />
...
// Wave - decorative
export function WaveIcon({ size = 20, className, ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      width={size}
    ...
    >
      ...
      <path d="M2 17c1.5-2 3-3 5-3s3.5 2 5 2 3.5-2 5-2 3.5 1 5 3" />
    </svg>
  )
}

// North Star - for navigation
export function NorthStarIcon({ size = 20, className, ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      width={size}
      ...
      {...props}
    >
      <polygon points="12,2 13.5,9 20,9 15,13 17,20 12,16 7,20 9,13 4,9 10.5,9" />
    </svg>
  )
}

// Arrow right - for links/CTAs
...
// Bot/AI icon
export function BotIcon({ size = 20, className, ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      width={size}
...
export function CoinIcon({ size = 20, className, ...props }: IconProps) {
  return (
    ...
    >
      <circle cx="12" cy="12" r="9" />
      <path d="M14.5 9c-.5-1-1.5-1.5-2.5-1.5-2 0-3 1.5-3 2.5s1 2 3 2.5c2 .5 3 1.5 3 2.5s-1 2.5-3 2.5c-1 0-2-.5-2.5-1.5" />
...
// Trending/Trading icon
export function TrendingIcon({ size = 20, className, ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      width={size}
...
// Zap/Lightning icon for fast/instant
...
// Chest/Treasure icon for DeFi/vaults
export function TreasureIcon({ size = 20, className, ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      width={size}
