...
function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="group rounded-full bg-white/90 px-3 py-2 shadow-lg ring-1 shadow-zinc-800/5 ring-zinc-900/5 backdrop-blur-sm transition dark:bg-zinc-800/90 dark:ring-white/10 dark:hover:ring-white/20 cursor-pointer"
    ...
    >
      {resolvedTheme === 'dark' ? (
        ...
        <MoonIcon className="h-6 w-6 fill-zinc-700 stroke-zinc-500 transition group-hover:stroke-zinc-700" />
      )}
    </button>
  )
}
