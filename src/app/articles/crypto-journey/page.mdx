...
<figure className="my-8">
  ...
  <figcaption className="text-center text-sm text-zinc-500 dark:text-zinc-400 mt-2">
    <a href="https://github.com/ADWilkinson/send-f-coin" target="_blank" rel="noopener noreferrer" className="text-teal-500 hover:text-teal-600">My groundbreaking contribution to blockchain technology</a>
  </figcaption>
</figure>
