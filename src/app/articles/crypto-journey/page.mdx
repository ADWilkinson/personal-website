...
<figure className="my-8">
  ...
  />
  <figcaption className="text-center text-sm text-[var(--text-secondary)] mt-2">Link Marines</figcaption>
</figure>
...
<figure className="my-8">
  ...
  <figcaption className="text-center text-sm text-[var(--text-secondary)] mt-2">
    <a href="https://github.com/ADWilkinson/send-f-coin" target="_blank" rel="noopener noreferrer" className="text-[var(--accent-primary)] hover:underline">My groundbreaking contribution to blockchain technology</a>
  </figcaption>
</figure>
...
<figure className="my-8">
  <Image
    ...
    className="rounded-lg shadow-lg"
  />
  <figcaption className="text-center text-sm text-[var(--text-secondary)] mt-2">We build On-chain Investment Themes - Galleon's unique 17th century branding</figcaption>
</figure>
...
<figure className="my-8">
  <Image
    ...
    className="rounded-lg shadow-lg"
  />
  <figcaption className="text-center text-sm text-[var(--text-secondary)] mt-2">Memes rule the world</figcaption>
</figure>
...
<figure className="my-8 text-center">
  ...
  />
  <figcaption className="text-sm text-[var(--text-secondary)] mt-4">— Andrew / Davy Jones</figcaption>
</figure>

<div className="border-t border-[var(--border-default)]/20 pt-8 mt-12">
