...
<div className="lead-paragraph mb-5 text-base text-zinc-600 dark:text-zinc-400">
  <p>Automation is a cornerstone of trading activity within DeFi, with examples of this being active liquidity management, arbitrage opportunities between AMMs, yield position compounding, and active trading strategies. I've been having fun tinkering away with <a href="https://claude.ai" className="text-teal-600 dark:text-teal-400 hover:underline">claude.ai</a> lately and wanted to see if I could build something a little more interesting in a couple of days and write about my experience.</p>
</div>
...
<div className="space-y-4">
  <div className="p-3 border-l-4 border-teal-500 bg-teal-50 dark:bg-zinc-800 dark:border-teal-400 rounded-r-lg">
  ...
  <div className="p-3 border-l-4 border-blue-500 bg-blue-50 dark:bg-zinc-800 dark:border-blue-400 rounded-r-lg">
...
<div className="my-5 p-3 bg-zinc-100 dark:bg-zinc-800 rounded-xl shadow-sm border border-zinc-200 dark:border-zinc-700">
  <h3 className="font-semibold mb-2 text-zinc-800 dark:text-zinc-200">Future Plans</h3>
  ...
  <ul className="mt-3 space-y-1 list-disc list-inside text-zinc-700 dark:text-zinc-300 text-base">
...
<p className="text-base text-center text-zinc-600 dark:text-zinc-400 my-5">I hope you enjoyed the read!</p>

<div className="border-t border-zinc-200 dark:border-zinc-700 pt-5 mt-6">
  <h2 className="font-bold tracking-tight text-zinc-800 dark:text-zinc-100 mb-4">Connect</h2>
