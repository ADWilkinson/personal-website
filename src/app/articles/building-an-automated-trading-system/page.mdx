...
<div className="my-6 p-4 bg-zinc-100 dark:bg-zinc-800 rounded-xl shadow-sm border border-zinc-200 dark:border-zinc-700">
  <h3 className="font-semibold mb-3 text-zinc-800 dark:text-zinc-200">Future Plans</h3>
