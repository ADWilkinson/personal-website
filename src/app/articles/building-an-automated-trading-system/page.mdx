...
![System Architecture](/articles/building-an-automated-trading-system/images/system-architecture.png)
...
![Config Retrieval](/articles/building-an-automated-trading-system/images/config-retrieval.png)
...
![Execution Function](/articles/building-an-automated-trading-system/images/execution-function.png)
...
![Position Closure Function](/articles/building-an-automated-trading-system/images/position-closure.png)
...
![Fetch Market Data Function](/articles/building-an-automated-trading-system/images/fetch-market-data.png)
...
![Trade Execution Function](/articles/building-an-automated-trading-system/images/dashboard.png)
...
![Cleanup Functions](/articles/building-an-automated-trading-system/images/cleanup-functions.png)

![Portfolio Value Function](/articles/building-an-automated-trading-system/images/portfolio-value.png)
...
2. **The AI is not always right, and that's okay!** The experiment wasn't to see if the AI could replace me in developing the bot entirely; it was to see how much faster I could work with it assisting it—and the TLDR here is much quicker. There were a lot of minor business logic errors or slight quirks in the output of what was being generated, and simply because I am familiar with the stack, I could easily navigate and steer it back on track or correct it myself. Building this system in a stack I am unfamiliar with and having full AI autopilot, I'm not sure we're there yet.
