...
<div className="mt-8 border-t border-[var(--border-default)]/20 pt-6">
  ...
  <div className="flex gap-4 justify-center">
    <a
      ...
      className="inline-flex h-12 w-12 items-center justify-center rounded-full border border-[var(--border-muted)] bg-[var(--surface-muted)]/70 transition-colors duration-90 hover:bg-[var(--surface-muted)]"
      aria-label="GitHub"
    >
