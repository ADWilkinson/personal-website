...
<figure className="my-8 text-center">
  <Image
    ...
    height={400}
  />
  <figcaption className="text-center text-sm text-[var(--text-secondary)] mt-2">This is actually a random, fun asset I had from a previous project, now reused!</figcaption>
</figure>
...
<figure className="my-8">
  ...
  />
  <figcaption className="text-center text-sm text-[var(--text-secondary)] mt-2">Loading up the home server</figcaption>
</figure>
